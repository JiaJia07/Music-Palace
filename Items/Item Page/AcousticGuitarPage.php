<!-- Select Acoustic Guitar from SQL -->
<?php
...
<html>
    <head>
    <title> Acoustic Guitars | Music Palace</title>
    <link href="/Assignment/style/ItemPageStyle.css" rel="stylesheet">                
        <?php         
            include('../../Includes/header.php');
            include("../../Includes/nav.php");
            require 'AcousticGuitarHeader.php';?>      
    </head>
    <body>        
         <main>
            <?php
            ...
            <button type="submit" name="id" value="<?php echo $row["Item_ID"]; ?>" class="card">
                <div class="image">
                    <img src="../../Includes/Images/Items/<?php echo $row["Item_img"]; ?>">
                </div>
                <div class="caption">
                    <br>                   
